...
class Keyboard {
	...
	constructor(config) {
		...
		this.config.keyDown = resources.get("keyDown").split(" ");
		this.config.keyLeft = resources.get("keyLeft").split(" ");
		this.config.keyRight = resources.get("keyRight").split(" ");
		this.config.keySelect = resources.get("keySelect").split(" ");
		this.config.keyActivate = resources.get("keyActivate").split(" ");

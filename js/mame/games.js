...
class Games {
	...
	loaded() {
		var verifyedromsStr = resources.get("url_verifyroms");
		var listxmlStr = resources.get("url_listxml");
	...
	play(name, callback) {
		...
		var cmd = resources.get("shell_cmd_play", {"{name}": name});
